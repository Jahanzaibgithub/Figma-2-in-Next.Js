...
//   const numSlides = 4; // Update this with the total number of slides
...
//               <div className="PartnershipContainer1 w-full lg:w-4/6 ">
...
//     </div>
//     </div>
//     <div className="RightArrow hidden lg:block cursor-pointer" onClick={nextSlide}>
//            {isRTL ? (
//            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
//             <rect width="40" height="40" fill="#D12D2D" />
//             <path d="M18.6678 10.6665L9.33447 19.9998L18.6678 29.3332" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
...
//       <SwiperSlide className="h-96"> <div className="slide slide_1 flex flex-col lg:m-0 lg:flex-row justify-center items-center text-start gap-10">
//               <div className="PartnershipContainer1 w-full lg:w-3/6 ">
//                 <h1 className="text-black font-[open-sans] text-xl lg:text-[28px] font-bold leading-normal">
//                   Early Childhood Development
//                 </h1>
//                 <p className="text-black font-[open-sans] text-base font-normal">
...
//               </div>
//             </div></SwiperSlide>
//       <SwiperSlide className="h-96"> <div className="slide slide_2 flex flex-col lg:m-0 lg:flex-row justify-center items-center text-start gap-10">
//               <div className="PartnershipContainer1 w-3/6">
//                 <h1 className="text-black font-[open-sans] text-xl lg:text-[28px] font-bold leading-normal">
//                   The Tanzania Cancer Care Project (TCCP)
//                 </h1>
//                 <p className="text-black font-[open-sans] text-base font-normal">
...
//               </div>
//             </div></SwiperSlide>
//       <SwiperSlide className="h-96"> <div className="slide slide_3 flex flex-col lg:m-0 lg:flex-row justify-center items-center text-start gap-10">
//               <div className="PartnershipContainer1 w-3/6">
//                 <h1 className="text-black font-[open-sans] text-xl lg:text-[28px] font-bold leading-normal">
//                   Early Childhood Development
//                 </h1>
...
//             </div>
//              </SwiperSlide>
//       <SwiperSlide className="h-96"> <div className="slide slide_4 flex flex-col lg:m-0 lg:flex-row justify-center items-center text-start gap-10">
//               <div className="PartnershipContainer1 w-3/6">
//                 <h1 className="text-black font-[open-sans] text-xl lg:text-[28px] font-bold leading-normal">
//                   The Tanzania Cancer Care Project (TCCP)
//                 </h1>
